...
function isAsymmetricMatcher(value) {
    return (typeof value === "object" &&
        value !== null &&
        "$$typeof" in value &&
        value.$$typeof === Symbol.for("muitto.asymmetricMatcher"));
}
// ============================================================================
// Stringify
// ============================================================================
...
function makeMatchers(actual, isNot) {
    ...
    const matchers = {
        ...
        toMatchSnapshot(options) {
            ...
            assert(result.pass, `Snapshot "${result.key}" does not match:\nExpected:\n${result.expected}\nReceived:\n${serialized}`, `Snapshot "${result.key}" matches unexpectedly`, result.expected);
        },
        // ============================
        // Negation
        // ============================
